...
client = Mongo::Client.new("mongodb://#{ENV["MONGODB_USER"]}:#{ENV["MONGODB_PASS"]}@#{ENV["MONGODB_CONTAINER"]}:#{ENV["MONGODB_PORT_NUMBER"]}/#{ENV["MONGODB_DATABASE"]}?authSource=admin&retryWrites=true&w=majority&ssl=false")
